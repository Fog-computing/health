...
public class FastDHTClient {
     ...
     * @return 0 for success, != 0(errno) for fail
     */
    public int set(KeyInfo keyInfo, byte[] value, int expires) {
        ServerInfo server;
     ...
     */
    public int delete(KeyInfo keyInfo) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
     ...
     * @return none null for success, null for fail
     */
    public byte[] getBytes(KeyInfo keyInfo) throws MyException {
     ...
     * @return none null for success, null for fail
     */
    public byte[] getBytes(KeyInfo keyInfo, int expires) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        int value_len;
     ...
     * @return none null for success, null for fail
     */
    public Long inc(KeyInfo keyInfo, int increment, int expires) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        int offset;
     ...
     * @return success set key count, < 0 for all keys fail
     */
    public int batchSet(ObjectInfo objInfo, Map keyValues, Map failKeys, int expires) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        int offset;
    ...
    public int batchDelete(ObjectInfo objInfo, String[] keys, Map failKeys) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        int offset;
     ...
     */
    @SuppressWarnings("unused")
    public Hashtable batchGet(ObjectInfo objInfo, String[] keys, Map failKeys, int expires) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        int offset;
     ...
     */
    @SuppressWarnings("unused")
    public String[] getSubKeys(ObjectInfo objInfo) {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        byte status;
